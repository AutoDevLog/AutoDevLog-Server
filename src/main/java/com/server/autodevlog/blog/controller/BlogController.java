...
public class BlogController {
    ...
    public ResponseEntity<PostingResultDto> velogPosting(@AuthenticationPrincipal Member member, @RequestBody VelogPostRequestDto velogPostRequestDto) {
        PostingResultDto result = blogService.postToVelog(member, velogPostRequestDto);
    ...
    public ResponseEntity<PostingResultDto> velogPostingNew(@AuthenticationPrincipal Member member, @RequestBody GPTArticleUploadRequestDto dto) {
        PostingResultDto result = blogService.postToVelog(member, new VelogPostRequestDto(dto.getTitle(), gptArticleService.findArticleContent(dto)));
        return ResponseEntity.status(HttpStatus.CREATED).body(result);
    }
}
